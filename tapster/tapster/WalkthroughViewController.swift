...
class WalkthroughViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func createContentPages() {
        ...
        pageStrings.append("Taptimal keeps you at the peak of your game, helping you work harder, play better and train stronger.")
        pageStrings.append("Taptimal is based on the finger-tapping test, which reflects the health of your central nervous system (CNS). Your mental and physical performance is controlled by your CNS, and demanding cognitive or physical tasks are best performed when your CNS is at its strongest. Taptimal let’s you know when those optimal days are.")
